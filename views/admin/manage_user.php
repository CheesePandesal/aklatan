    ...
    <div class="main-container">
        ...
        <main>
            <div class="user-title">
                <h1>Manage <span class="user-name">Users</span></h1>
            </div>
            <!-- Modal container for Adding User -->
                ...
                <div class="container">
                    <div class="container-header" style="align-items: center;">
                        ...
                        <div style="display: flex;">
                            <input type="text" id="search-input" placeholder="Search for a user..." style="background-color: #f9f9f9; border: none; width: 300px; margin: 0px; border-radius: 9px; padding: 13px 15px;">
                        </div>
                        <button id="add-btn">Add New User</button>
                    </div>
