...
<head>
    ...
    <script type="text/javascript" src="../../assets/js/reports.js" defer></script>
                ...
                <div class="container">
                    <div class="container-header" style="align-items: center;">
                        ...
                        <div style="display: flex; gap: 10px;">
                            <select id="selectedFilter" style="background-color: #f9f9f9; border: none; width: 300px; margin: 0px; border-radius: 9px; padding: 13px 15px;">
